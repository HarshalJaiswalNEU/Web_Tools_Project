...
<!--     <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script> -->
    ...
    <link rel="stylesheet" type="text/css" href="${contextPath}/css/headerandfooter_1.css">
    <link rel="stylesheet" type="text/css" href="${contextPath}/css/postAJob1.css">
...
<body>
    ...
    <div class="jumbotron">
        <h1 id="myHeader" style="color: black;">POST A JOB</h1>
